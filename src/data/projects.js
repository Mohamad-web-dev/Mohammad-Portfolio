...
export const projects = [
  {
    ...
    description: {
      fa: "یک داشبورد مدیریت جامع در دوران یادگیری state، برای تمرین مدیریت state‌های کامپوننت‌های تو‌درتو.",
      en: "A comprehensive admin dashboard built while learning state management, for practicing nested-component state.",
    },
    tags: [
      "Recharts",
      "bootstrap",
  ...
  },
  {
    ...
    description: {
      fa: "یک دموی برنامه هواشناسی برای نمایش وضعیت هوا به‌صورت زنده، با انیمیشن‌های نرم و طراحی مینیمال.",
  ...
  },
  {
    ...
    tags: ["Tailwind CSS", "bootstrap", "React", "redux-toolkit"],
